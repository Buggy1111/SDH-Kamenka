      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center text-white">
        ...
        >
          ...
          <motion.h1
            ...
            className="mb-4 font-display text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl"
          >
            POMÁHÁME A{' '}
          ...
          <motion.p
            ...
            className="mb-6 text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto"
          >
          ...
          >
            <Link href="/kontakt">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-red-600 to-orange-600 px-6 py-3 font-bold text-white transition-all hover:from-red-700 hover:to-orange-700 shadow-xl hover:shadow-2xl border-2 border-red-700"
              >
            ...
            <Link href="/o-nas">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="rounded-lg bg-white/20 backdrop-blur-md border-2 border-white/30 px-6 py-3 font-bold text-white transition-all hover:bg-white/30 hover:border-white/50 shadow-xl"
              >
              ...
              return (
                <Link key={stat.label} href={getNavigationPath(stat.label)}>
                  <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="bg-white backdrop-blur-md border-2 border-white rounded-lg p-3 shadow-2xl cursor-pointer hover:shadow-3xl transition-all hover:border-red-300"
                  >
                    <stat.icon className="h-5 w-5 mx-auto mb-2 text-red-600" />
                    <div className="text-3xl font-black text-gray-900">{stat.value}</div>
                    <div className="text-sm text-gray-800 font-bold mt-1">{stat.label}</div>
                    {/* Hover indikátor */}
